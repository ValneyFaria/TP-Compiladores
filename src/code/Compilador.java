...
public class Compilador {
	...
	ArrayList<Token> findTokens(String source) {
		...
		System.out.println("\n\nBUSCANDO TOKENS");
		// Enquanto todos os caracteres n�o forem lidos
		while (i != source.length()) {
			...
			// Se o caractere n�o � separador nem operador
			...
			// Verifica se o caractere � um separador
				...
				if (isOperador(sBefore)) {
					System.out.println("Caractere Anterior � separador!");
				...
				// Verifica se o simbolo anterior � um separador
			...
			// Verifica se o caractere � um operador
			...
			// Se i � igual ao tamanho da palavra e o concanetado n�o � nem
	...
	// Remove os Espa�os na Lista de Tokens
